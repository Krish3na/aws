...
# Replace these values with your actual Agent ID and Alias ID
AGENT_ID = "7O7K1PIKKL" 
AGENT_ALIAS_ID = "5HHGONOVZJ"
...
def lambda_handler(event, context):
    try:
        ...
        # Handle raw text or JSON response
        try:
            ...
            # If JSON parsing fails, treat it as a raw text response
